The goal in creating this application is to better understand and practice our skills of ORMs, creating models, migrating models, relationships to models, foreign key relationships, and writing queiries. 
